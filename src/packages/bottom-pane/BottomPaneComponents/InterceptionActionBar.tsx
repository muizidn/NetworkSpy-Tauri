        ...
        {isMultiple ? (
          <>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-bold text-zinc-300 tracking-tight">{tunneledCount} Tunneled</span>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]" />
              <span className="text-[10px] font-bold text-zinc-300 tracking-tight">{interceptedCount} Intercepted</span>
            </div>
          </>
        ) : (
          <div className="flex items-center gap-2">
            {isIntercepted ? (
              ...
              <>
                ...
                <span className="text-[10px] font-bold text-zinc-400 tracking-widest">Direct Tunnel</span>
              </>
            )}
          </div>
        )}
