    ...
    <div className="h-full bg-zinc-950 p-4 @sm:p-6 flex flex-col items-center overflow-auto">
      <div className="max-w-3xl w-full">
        <div className="flex items-center gap-4 mb-10 pb-6 border-b border-zinc-900">
          ...
          <div>
            <h2 className="text-2xl font-black text-white tracking-tighter">AI Security Auditor</h2>
            <div className="text-[10px] text-zinc-500 font-bold tracking-widest italic">Deep heuristic vulnerability analysis for {selectedItems.length} items</div>
          </div>
        </div>
        ...
        {!report ? (
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl animate-in fade-in zoom-in duration-500">
            <div className="flex justify-between items-center mb-6 pb-4 border-b border-zinc-800">
              <span className="text-[10px] font-black text-red-500 tracking-widest flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
                Executive Security Summary
              </span>
              <button onClick={() => setReport(null)} className="text-[10px] text-zinc-600 font-bold hover:text-white">Re-scan</button>
            </div>
            ...
            <div className="mt-8 flex gap-4">
              <div className="flex-grow bg-red-900/10 border border-red-900/20 rounded-xl p-4">
                <div className="text-[10px] font-black text-red-500 tracking-widest mb-1">Risk Level</div>
              ...
              <div className="flex-grow bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center">
                <button className="text-[10px] font-black text-zinc-500 hover:text-white transition-colors h-full w-full">Export PDF Report</button>
              </div>
            </div>
          </div>
        )}
