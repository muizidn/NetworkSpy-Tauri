      ...
      <div className="flex items-center px-4 py-2 border-b border-zinc-800 bg-[#111] justify-between z-10 shadow-xl">
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-3 py-1 rounded-md text-[10px] font-black transition-all border ${
                isFormatted 
        ...
        <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
                <span className="text-[10px] font-bold text-zinc-600 uppercase">Left:</span>
                <select 
                    value={leftIdx}
            ...
            <div className="flex items-center gap-2">
                <span className="text-[10px] font-bold text-zinc-600 uppercase">Right:</span>
                <select 
                    value={rightIdx}
