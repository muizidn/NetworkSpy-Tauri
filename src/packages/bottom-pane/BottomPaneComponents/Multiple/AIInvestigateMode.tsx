        ...
        <div className="max-w-3xl w-full">
          <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                  ...
                  <div className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">Deep Analysis Context: {selectedItems.length} Items</div>
              </div>
          </div>
          ...
          {answer && (
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="flex items-center gap-2 mb-6 border-b border-zinc-800 pb-4">
                      ...
                      <span className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.3em]">Investigation Results</span>
                  </div>
