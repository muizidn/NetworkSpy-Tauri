        ...
        <div className="h-full bg-[#050505] flex flex-col overflow-hidden">
            <div className="flex flex-col @sm:flex-row items-start @sm:items-center px-4 @sm:px-6 py-4 border-b border-zinc-900 bg-[#0a0a0a] justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-black text-white tracking-tighter">Supabase Inspector</h2>
                        <div className="text-[9px] text-zinc-500 font-bold tracking-widest">PostgreSQL Backend</div>
                    </div>
                </div>
                ...
                {isSupabase && (
                    <div className="px-3 py-1 bg-emerald-950/30 border border-emerald-900/50 rounded-full flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-emerald-500 tracking-widest">{projectName}</span>
                    </div>
                )}
            </div>
                ...
                <div className="grid grid-cols-1 @sm:grid-cols-2 gap-4 max-w-6xl">
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5 hover:border-emerald-500/20 transition-colors">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-xs font-black text-zinc-400 tracking-wider">REST / PostgREST</h3>
                        </div>
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5 hover:border-emerald-500/20 transition-colors">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-xs font-black text-zinc-400 tracking-wider">Auth Context</h3>
                        </div>
                        <div className="space-y-3">
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5 @sm:col-span-2">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2 text-emerald-500">
                                <FiDatabase size={16} />
                                <h3 className="text-xs font-black text-zinc-400 tracking-wider">Query / Body Params</h3>
                            </div>
                        ...
                        <div className="grid grid-cols-1 @lg:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <h4 className="text-[10px] text-zinc-500 font-black tracking-widest">Filters</h4>
                            ...
                            <div className="space-y-2">
                                <h4 className="text-[10px] text-zinc-500 font-black tracking-widest">Payload</h4>
...
const Placeholder = ({ text }: { text: string }) => (
    <div className="h-full flex flex-col items-center justify-center bg-[#050505] p-6 @sm:p-10 text-center">
        <div className="w-16 h-16 @sm:w-20 @sm:h-20 rounded-full bg-emerald-600/5 flex items-center justify-center text-emerald-950 mb-6 border border-emerald-950/10">
            <SiSupabase className="w-8 h-8 @sm:w-10 @sm:h-10 opacity-20" />
        </div>
