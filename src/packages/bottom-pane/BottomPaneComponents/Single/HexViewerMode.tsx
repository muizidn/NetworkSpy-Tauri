...
export const HexViewerMode = () => {
    ...
    return (
        <div className="bg-[#050505] flex flex-col min-h-full h-full font-sans relative overflow-hidden">
            ...
            {/* Premium Toolbar */}
            <div className="flex items-center justify-between px-6 py-4 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-emerald-500/10 relative z-10">
                <div className="flex items-center gap-4">
                    <div className="relative group">
                        ...
                        <div className="w-10 h-10 rounded-xl bg-emerald-600/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shadow-2xl relative z-10">
                            <FiHash size={22} />
                        </div>
                    </div>
                    <div>
...
const Placeholder = ({ text }: { text: string }) => (
    <div className="h-full flex items-center justify-center text-zinc-500 bg-[#050505] font-sans relative">
        ...
        <div className="text-center relative z-10">
            <div className="w-20 h-20 bg-emerald-600/5 rounded-3xl border border-emerald-500/10 flex items-center justify-center text-emerald-500 mx-auto mb-6 shadow-2xl relative">
