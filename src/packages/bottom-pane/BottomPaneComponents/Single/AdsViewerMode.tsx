    ...
    <div className="h-full bg-[#050505] flex flex-col overflow-hidden">
      <div className="flex flex-col @sm:flex-row items-start @sm:items-center px-4 @sm:px-4 @sm:px-6 py-4 border-b border-zinc-900 bg-[#0a0a0a] justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-black text-white uppercase tracking-tighter">{adNetwork} Inspector</h2>
            <div className="text-[9px] text-zinc-500 font-bold uppercase tracking-widest">Marketing & Ads Network</div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 @sm:grid-cols-2 gap-4 max-w-6xl">
            ...
            <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5">
                <div className="flex items-center gap-2 mb-4 text-blue-500">
                    <FiActivity size={16} />
                    <h3 className="text-xs font-black text-zinc-400 uppercase tracking-wider">Event Trigger</h3>
                </div>
                <div className="space-y-3">
