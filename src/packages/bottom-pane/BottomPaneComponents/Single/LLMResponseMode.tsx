    ...
    <div className="flex flex-col h-full bg-[#15181a] text-zinc-300 overflow-hidden select-none">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-[30%] border-r border-zinc-900 bg-black/5 flex flex-col">
          <div className="p-4 @sm:p-6 space-y-6">
            ...
            <div className="pt-4 border-t border-zinc-800/50">
              <button className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-[10px] font-bold transition-all border border-zinc-600/20 active:scale-95">
                <FiCode size={14} />
                Deep Raw Inspection
              </button>
            </div>
        ...
        <div className="w-[70%] bg-[#111314] flex flex-col">
          <div className="px-6 py-3 bg-zinc-900/30 border-b border-zinc-800 text-[10px] font-bold text-zinc-500 tracking-[0.2em] flex items-center justify-between">
