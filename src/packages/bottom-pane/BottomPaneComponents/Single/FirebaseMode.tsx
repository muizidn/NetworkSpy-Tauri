        ...
        <div className="h-full bg-[#050505] flex flex-col overflow-hidden">
            <div className="flex flex-col @sm:flex-row items-start @sm:items-center px-4 @sm:px-4 @sm:px-6 py-4 border-b border-zinc-900 bg-[#0a0a0a] justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-black text-white tracking-tighter">Firebase Inspector</h2>
                        <div className="text-[9px] text-zinc-500 font-bold tracking-widest">Backend-as-a-Service</div>
                    </div>
                </div>

                {!isFirebase && data && (
                    <div className="px-3 py-1 bg-red-950/30 border border-red-900/50 rounded-full shrink-0">
                        <span className="text-[10px] font-black text-red-500 tracking-widest">Non-Firebase Traffic</span>
                    </div>
                )}
            </div>
                ...
                <div className="grid grid-cols-1 @sm:grid-cols-2 gap-4 max-w-6xl">
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-xs font-black text-zinc-400 tracking-wider">Service Details</h3>
                        </div>
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-xs font-black text-zinc-400 tracking-wider">Authentication</h3>
                        </div>
                        <div className="space-y-3">
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-5 @sm:col-span-2">
                        <div className="flex items-center gap-2 mb-4 text-orange-500">
                            <FiDatabase size={16} />
                            <h3 className="text-xs font-black text-zinc-400 tracking-wider">Document / Data Body</h3>
                        </div>
...
const Placeholder = ({ text }: { text: string }) => (
    <div className="h-full flex flex-col items-center justify-center bg-[#050505] p-4 @sm:p-6 @sm:p-6 @sm:p-10 text-center">
        ...
        <h3 className="text-zinc-400 font-bold mb-1 italic tracking-widest text-xs">Firebase Inspector</h3>
