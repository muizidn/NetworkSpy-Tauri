    ...
    <div className="h-full bg-[#050505] flex flex-col overflow-hidden">
      <div className="flex flex-col @sm:flex-row items-start @sm:items-center px-4 @sm:px-6 py-4 border-b border-zinc-900 bg-[#0a0a0a] justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-black text-white tracking-tighter">MobSF Mobile Engine</h2>
            <div className="text-[9px] text-zinc-500 font-bold tracking-widest italic text-green-600/70">Mobile Security Framework Integration</div>
          </div>
        </div>

        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end">
            <span className="text-[9px] font-black text-zinc-600">Security Score</span>
      ...
      <div className="flex-grow p-4 @sm:p-6 overflow-y-auto no-scrollbar pb-10">
          ...
          {findings.map((f) => (
            <div key={f.id} className="relative group bg-zinc-900/30 border border-zinc-800/80 rounded-2xl p-5 hover:bg-zinc-900/50 transition-all duration-300">
              ...
              <div className="mt-4 pl-4 flex gap-2">
                <span className="text-[9px] font-black bg-zinc-800 text-zinc-500 px-2 py-0.5 rounded">{f.id}</span>
        ...
        <div className="mt-8 p-4 @sm:p-6 bg-gradient-to-br from-zinc-900 to-transparent border border-zinc-800 rounded-2xl">
          <h4 className="text-[10px] font-black text-zinc-500 tracking-widest mb-4">Heuristic Traffic Analysis</h4>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-black/30 rounded-xl border border-zinc-800/50">
              <div className="text-[9px] font-bold text-zinc-600 mb-1">Insecure Storage</div>
              <div className="text-xs font-mono text-zinc-400">Not Detected</div>
            </div>
            <div className="p-3 bg-black/30 rounded-xl border border-zinc-800/50">
              <div className="text-[9px] font-bold text-zinc-600 mb-1">Hardcoded Keys</div>
