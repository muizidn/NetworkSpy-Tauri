    ...
    <div className="h-full bg-[#1e1e1e] flex flex-col">
      <div className="flex flex-col @sm:flex-row items-start @sm:items-center px-4 py-2 border-b border-zinc-800 bg-zinc-900 justify-between gap-2">
        <div className="flex items-center gap-3">
          <span className="text-[10px] font-black bg-cyan-600 text-white px-2 py-0.5 rounded tracking-tighter">WS</span>
          <span className="text-[9px] @sm:text-[10px] text-zinc-500 font-mono truncate max-w-[120px] @sm:max-w-none">ID: {trafficId}</span>
        </div>
        <div className="text-[9px] @sm:text-[10px] text-green-500 font-bold flex items-center gap-1">
      ...
      <div className="flex-grow overflow-auto p-1 @sm:p-2 space-y-1 font-mono text-[10px] @sm:text-[11px]">
        ...
        <div className="pt-4 text-center text-zinc-700 text-[9px] font-bold tracking-[0.2em]">End of Log</div>
      </div>
