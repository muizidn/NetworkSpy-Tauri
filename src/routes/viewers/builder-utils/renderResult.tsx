...
export const renderResult = (type: ViewerBlock['type'], data: any) => {
    ...
    switch (type) {
        ...
        case 'html':
            return (
                <div className="w-full bg-white rounded-2xl overflow-hidden border border-zinc-800 min-h-[200px] flex flex-col">
                    <div className="px-4 py-2 bg-zinc-100 border-b border-zinc-200 flex items-center justify-between shrink-0">
                        <span className="text-[10px] font-black uppercase text-zinc-400 tracking-widest">Sandboxed Preview</span>
                    </div>
                    <iframe 
                        srcDoc={String(data)} 
